// app/agenda/page.tsx — met highlights, toggle, zoekfunctie en floating button
"use client";
...
export default function AgendaPage() {
  ...
  return (
    <main className="bg-[#fefaf5] min-h-screen px-4 py-6 max-w-5xl mx-auto">
      ...
      <Link
        href="/upload"
        className="fixed bottom-6 right-6 bg-[#c9b6a0] text-white p-3 rounded-full shadow-lg hover:bg-[#bfa88f] transition"
      >
        <Plus size={24} />
      </Link>
    </main>
